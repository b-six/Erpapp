        ...
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo base_url('marketing/produk_baru/tambahProduk')?>" class="col s12" id="form-add-pb" enctype="multipart/form-data">
                ...
                <div class="row" style="display: none;">
                    <div class="input-field col s12">
                        <input id="nama-tampilanProduk" name="tampilan-produk" id="tampilan-produk" name="tampilan-produk" type="text" data-url_simpan="<?php echo base_url('marketing/produk_baru/uploadGambar'); ?>" >
                    </div>
                </div>
            </form>
                ...
                <div class="input-field col s12">
                    ...
                    <div class="row">
                        <div class="col s8 center-align">
                            <div id="image-view" style=""></div>
                        </div>
                        <div class="col s4 center-align">
                            <button class="btn upload-result" style="display: none;">Upload Image</button>
                        </div>
                    </div>
                    <!-- /image viewport -->
                </div>
