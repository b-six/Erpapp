    ...
    <nav class="no-shadows">
        <div class="nav-wrapper blue-dark-grey darken-4">
            ...
            <ul id="plan_DD" class="dropdown-content indigo darken-4">
                <li><a href="buat_planning" class="white-text">Perencanaan Produksi</a></li>
            ...
            <ul id="nav-mobile" class="right hide-on-med-and-down">
                <li><a class="bold-font dropdown-trigger" href="#plan_DD" >PLAN <i class="material-icons right">arrow_drop_down</i> </a></li>
